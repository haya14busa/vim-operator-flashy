...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_operator_flashy#Vim#Buffer#import() abort
  ...
  execute join(['function! vital#_operator_flashy#Vim#Buffer#import() abort', printf("return map({'_vital_depends': '', 'read_content': '', 'get_selected_text': '', 'is_cmdwin': '', 'edit_content': '', 'open': '', 'get_last_selected': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
